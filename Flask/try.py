...
def signup():
    if (request.method == 'POST'):
         ...
         if (request.form['username'] and request.form['password'] ):
             user_insert_query = "insert into(email_id,kindle_id,password,frequency,categories) user values('%s','%s','%s','%s','%s')" %(request.form['username'],request.form['kindle_id'],request.form['password'],request.form['frequency'],request.form.getlist('categories'))
